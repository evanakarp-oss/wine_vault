...
updated: 2026-06-19
parent_thread: "https://www.wineberserkers.com/t/wine-berserkers-wine-talk-hall-of-fame-thread/129985"
parent_thread_id: 129985
---

# Berserkers Hall of Fame — thread registry

Prioritized subset of the WB *Wine Talk Hall of Fame* that Evan flagged
(2026-06-19) for cataloguing. Distillations live in
[`wiki/_views/wb_hall_of_fame_2026_06.md`](../../../wiki/_views/wb_hall_of_fame_2026_06.md).
All currently `snippet` fidelity — see `README.md` for the access constraint.

| # | slug | title (verbatim) | thread_id | url | category | fidelity |
|---|---|---|---|---|---|---|
| 1 | chardonnay_blowout | The 16 bottle Chardonnay Blowout Challenge! | 101084 | https://www.wineberserkers.com/t/the-16-bottle-chardonnay-blowout-challenge/101084 | humor / aging-experiment | snippet |
...
Discourse numeric id wasn't surfaced by search. Backfill when transcribed.

## Cellar-relevance map (to Evan's curation taste)

- **4 trad/modern Barolo · 5 N. Rhône tour · 8 off-beat Burgundy · 10 buying Burgundy**
  — core lanes (Piedmont classicists, N. Rhône Syrah, grower Burgundy). Highest value.
- **7 trad/modern Bordeaux** — feeds the WK-style undercovered/classic-farming Bordeaux filter.
- **9 old-vine Zin vineyards** — vineyard-atlas, adjacency to the Bedrock/Carlisle/Ridge
  field-blend world already strong in the cellar.
- **3 Sonoma travel** — trip planning, restrained-Sonoma tasting-room map.
- **1 Chardonnay blowout · 2 '07 Oregon Pinot** — aging-curve lessons (cheap aged Chard
  holds; written-off vintages rehabilitate).
- **6 Premier Cru fraud · 11 root cellar** — cautionary (retailer pre-arrival risk) and
  practical (passive storage build).
</content>
