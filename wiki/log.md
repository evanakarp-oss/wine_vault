...
## [2026-06-01] view | Cool-climate mountain Cabernet — Bedrock-style discovery

Query: off-the-radar rugged dry-farmed mountain Cab in the mold of Bedrock Wine Co.'s sources (Montecillo / Moon Mountain corridor; "Lazy Dog" reference). Web-researched June 2026. Anchor template = Montecillo Vineyard (Moon Mountain District, late-1960s dry-farmed, ~1,400–2,200', the Bedrock heritage Cab). Filed shortlist to `wiki/_views/gap_mountain_cabernet_bedrock_style_2026_06.md`. Tier 1 candidates: Far Mountain (`Fission`, Moon Mountain / The Nunnery), Mount Eden Vineyards (Santa Cruz Mtns estate, dry-farmed), Renaissance Vineyard & Winery (North Yuba / Sierra granite). Tier 2: Lasseter, Coturri, Monte Rosso bottlings, Smith-Madrone, Robert Craig. Flags the structural gap: the in-vault California rollup is all cult-hedonist tier (Colgin/Schrader/Screaming Eagle/Hundred Acre/SQN) — the exact style the post-2026-05-29 taste filter says to skip. None of these candidates have producer pages yet. Re-ran build_wiki_index.py.

## [2026-06-01] ingest | Onboard 3 off-radar mountain Cabernet producers (web-sourced)

Acted on the cool-climate mountain-Cab discovery view: created producer pages for the three Tier 1 candidates, sourced entirely from web research (June 2026) since none appear in CSW/Raeders/DTE/FASS feeds. Pages: `far_mountain` (Moon Mountain District, Sonoma — Rodrigo Soto; Fission Cab from ~50yo dry-farmed Alta Vista Gold Ranch + Phil Coturri's organic Nunnery; importer Vintus), `mount_eden_vineyards` (Santa Cruz Mountains — est. 1945 Martin Ray lineage; ~2,000' dry-farmed Franciscan shale; Jeffrey Patterson since 1981; La Questa cuttings; David Bowler dist.; + Domaine Eden second label), `renaissance_winery` (North Yuba / Sierra Foothills — Fellowship of Friends 1975; 1,700–2,300' decomposed-granite terraces; Gideon Beinstock era + "Taken from Granite" library label). Added `United States → California` block to `_TAXONOMY.md` (US producers previously skipped region validation). Traceable source notes filed under new `raw/web_research/` dir. Regenerated rollups (California 10→13) + index; lint 0. These are the first vault entries matching the post-2026-05-29 California-Cab taste (rugged/dry-farmed/site-transparent) rather than the cult tier.

## [2026-06-01] view | Benchmark Wine Group availability triage (mountain Cab)

Triaged a Benchmark Wine Group sub-$50 California Cabernet listing against the mountain-Cab discovery theme; appended a "Benchmark Wine Group availability (2026-06)" section to `wiki/_views/gap_mountain_cabernet_bedrock_style_2026_06.md`. Tier A keepers: Robert Craig Napa 2013, Maître de Chai Gala Mountain 2019 (Mt. George biodynamic), Stone Edge Farm Surround 2013 (Moon Mountain / Coturri-farmed), Ladera 2011, Viader DARE 2011. Tier B speculative aged: Kenwood Jack London 1994–96, Buehler 2003, Grgich Hills 1991, Chad Wine Co Spring Mtn 2013. Rest of the list (Hall/Faust/Pott/Amici/etc.) flagged skip = valley-floor/cult tier per the post-2026-05-29 taste filter.

## [2026-06-01] view | Add exploratory mountain-Cab leads (Mayacamas, Laurel Glen, Kathryn Kennedy, Dyer)

Appended a "Further leads to explore (ideas, not buy calls)" section to `wiki/_views/gap_mountain_cabernet_bedrock_style_2026_06.md` — broadening the discovery net per Evan's "ideas, not definitive picks" steer. Verified (web, June 2026): Mayacamas Vineyards (Mt. Veeder, CCOF organic, austere — the axis's key reference), Laurel Glen (Sonoma Mountain, organic/Coturri-farmed; corrected: organic not dry-farmed), Kathryn Kennedy (Santa Cruz Mtns, own-rooted 1973, organic since 2007), Dyer Vineyard (Diamond Mountain micro-cuvée). Plus unverified threads to chase (Random Ridge, Brandlin, Clos Saron, Obsidian Ridge, Smith-Madrone, Cain). No producer pages created — kept as leads.

## [2026-06-01] view | Benchmark batch 2 triage (mountain Cab) — incl. Bedrock Heritage

Triaged a second Benchmark Wine Group listing into the discovery view's Benchmark section ("Batch 2"). Headline: Bedrock "The Bedrock Heritage" 2017 ($55, the anchor producer — old-vine heirloom field blend, WS95/V94). Other on-theme keepers: Rowen Red 2014 (Cooley Ranch, far-N Sonoma, 2,040' high-elevation), Audelssa Summit Red 2005 (1,800' Sonoma-Mayacamas, winery now defunct/back-vintage), Two Terroirs Spring Mtn 2011, Frisson Atlas Peak Reserve 2018. Secondary old-school/farming-driven: BV Georges de Latour 1996 + BV Rutherford 1988, Clos du Val 2018, Grgich Hills (dry-farmed organic), Kunde Drummond (Sonoma Mtn block). Adjacent: Foxen (Santa Barbara), Soter (Oregon). Rest = skip (cult/commercial). Verified Audelssa + Rowen sites via web.

## [2026-06-01] view | Restrained/elegant Napa & Sonoma Cabernet canon

Built the house-style Cab reference list at `wiki/_views/restrained_napa_sonoma_cab_canon_2026_06.md` (the Dunn/Corison/Bedrock bucket Evan asked for). Grouped by terroir: Napa mountain (Howell/Veeder/Spring/Diamond/Pritchard restrained end), Napa valley-floor classics (Corison, Spottswoode, Frog's Leap, Heitz, Forman, Grgich, BV GdL, Dominus, Matthiasson, Ashes & Diamonds, Maître de Chai), Sonoma Mayacamas/Moon Mountain spine (Bedrock/Montecillo, Far Mountain, Hamel biodynamic, Monte Rosso bottlings, Stone Edge, Laurel Glen, Rowen), + Santa Cruz adjacent essentials (Ridge Monte Bello, Mount Eden, Kathryn Kennedy). Verified Hamel (Demeter biodynamic), Monte Rosso roster, restraint canon via web. Flagged next pages to promote: Bedrock, Mayacamas, Corison, Laurel Glen, Hamel.
...
## [2026-06-01] view | Triage Wine Advocate "Napa New Releases" list vs restrained profile

Researched a Wine Advocate "Napa: New and Recent Releases" debut-producer list (user screenshots) against the restrained/farming-driven profile; added a triage block to the Cab canon view. Strong fit: Pilcrow (Mt. Veeder + Coombsville; organic/dry-farmed/no-till regenerative; explicit pre-arms-race Napa ethos — flagged producer-page candidate). Worth-a-look: Alluvium "Gnome" (Coombsville, Hepworth), Sommras (Atlas Peak high-elevation), Marineau Mills (Calistoga hillside), Chris Corley/Monticello (Oak Knoll classic). Caveat: Monte Rosso Estate = Gallo old-vine label off the historic vineyard but plush — prefer Bedrock/Carlisle designates. Skipped modern/négociant/off-style (Adaptation, Phifer Pavitt, Old Soda Springs saignée, Calistoga Press, Aviatrix, Villa Ragazzi) and the no-signal micro-debuts. Noted Coombsville as a cool sub-AVA to watch.
