...
## [2026-06-04] ingest | JP (ex-Babbo somm) Barolo recs: 5 new producer pages + Roddolo orphan-cellar gap closed

Landed a personal recommendation from JP (former sommelier at Babbo, NYC) of six small craft-driven Barolo producers — "not really large wineries but farms with a master of craft." Verbatim source filed at `raw/recommendations/2026-06-04_jp_babbo_barolo.md` (new `raw/recommendations/` source folder). Created 5 producer pages: [[fratelli_barale|Fratelli Barale]] (Barolo commune; CSW ★ 2015; Castellero + Bussia, "vino da meditazione"), [[giacomo_fenocchio|Giacomo Fenocchio]] (Monforte/Bussia; CSW ★ 2020; organic, Slavonian oak), [[silvano_bolmida|Silvano Bolmida]] (Monforte/Bussia; 60–120 day macerations, "more powerful"; no CSW, web-verified), [[flavio_roddolo|Flavio Roddolo]] (Monforte/Bricco Appiani; CSW ★; copper+sulfur, "more powerful"), [[luigi_vico|Luigi Vico]] (Serralunga; ~2.1 ha certified-organic micro-grower, "more elegant but structured"; no CSW, web-verified). [[fratelli_alessandria|Fratelli Alessandria]] already existed — added JP note + tags. **Side discovery:** the Roddolo page closed an orphan-cellar-reference gap — 3 cellar entries (10 bottles: Langhe Cabernet 2010, Barbera Superiore 2012, Barolo Ravera 2013) pointed at `producer_slug: flavio_roddolo` with no page; now backfilled with a `## Cellar` section. Filed keeper view `wiki/_views/jp_babbo_barolo_recs.md`. Piedmont rollup 20 → 25 producers. Lint 0; index + rollups regenerated. Follow-up: Bolmida (Regal Wine Imports) and Vico (North Berkeley Imports) have no modeled retailer footprint — confirm US availability.
