...
## [2026-06-03] view | Burgundy value wines — WB thread cross-reference (Côte de Beaune / Volnay / Montrachet)

Cross-referenced a WineBerserkers "favorite value producers" thread (Côte de Beaune, ideally Volnay/Montrachet, $50–$150 reds & whites) against the vault. Filed `wiki/_views/burgundy_value_wines_2026_06.md`. ~20 named producers already have pages (Ramonet, Hudelot-Noëllat, Bertheau, Lignier-Michelot, Berthaut-Gerbet, Charles Audoin, Bruno Lorenzon, Latour-Giraud, Bouley, Mallard, Glantenay, Chandon de Briailles, Dujardin, Marchand-Tawse, Voillot, Rebourgeon, Forey, PYCM, Javillier, Lafouge). Gap shortlist ranked by filter fit — Tier 1: Lafarge (Volnay), Bruno Clair, Dureuil-Janthial, Hubert Lamy, William Fèvre, Marc Colin, Barthod. Skip: Jadot, Faiveley (negociant-tier), Coquard-Loison-Fleurot (glossy/modern). Flagged Bouley duplicate page (`jean_marc_et_thomas_bouley.md` + `thomas_et_jean_marc_bouley.md`) as a dedup candidate.
