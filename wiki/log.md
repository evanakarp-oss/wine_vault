...
## [2026-06-06] ingest | kelley_instagram producers batch 1 (Burgundy): 26 new pages

First staged batch onboarding William Kelley's Instagram producers (source: `wiki/_views/kelley_instagram_producers.md`) into `wiki/producers/`. Wrote `scripts/compile_kelley_instagram.py` (curated decision table, idempotent, only overwrites pages it generated). Created 26 Burgundy pages with web-researched region/sub_region/farming/importer: Roumier, Robert Groffier, Arnaud Tessier, Jean-Baptiste Boudier, Arnaud Chopin, Maison Fatien, Fourrier, Darviot-Perrin, Marshall, Baptiste Guyot, Naddef, Georges Joillot, Boyer-Martenot, Camille Thiriet, Briotet-d'Aprigny, Bruno Clair, Arlaud, Fabien Coche, Feuillat-Juillot, Robert-Denogent, Brunet-Randon, Bessin-Tremblay, des Sénons, Lefort, Ballot-Millot, Maume-Siblas. Research corrected 3 misfiled names out of the Burgundy batch: Muxin is Chinese (Yunnan), Lucas Salmon is Muscadet/Loire, Les Quatre Piliers is Touraine/Loire — deferred to later batches. Taxonomy additions: countries Australia/Japan/Canada/Sweden + Spain region Canary Islands (for upcoming batches). lint 0, index 598→624, rollups regenerated. Remaining batches: Loire, Rhône/Provence, Bordeaux, Italy, Germany/Austria, Spain/Portugal/Canaries, Chile, USA, Australia/Canada, Japan/Sweden, plus China (Muxin).

## [2026-06-06] ingest | kelley_instagram producers batch 2 (all remaining regions): 71 new pages

Completed the staged onboarding of William Kelley's Instagram producers. Extended `scripts/compile_kelley_instagram.py` decision table with 71 web-researched producers across Loire, Rhône/Provence, Bordeaux, Beaujolais/Corsica, Savoie, Alsace, Italy, Germany/Austria, Spain/Portugal/Canaries, Chile, USA, Australia/Canada, Japan, Sweden, China. Total now 98 producer pages carrying `discovery_source: william_kelley_instagram` (26 Burgundy batch 1 + 72 here, incl. Eric Bordelet cider/poiré). Research reclassified several misfiled names (Nathalie Richez/Guilbert-Gillet/du Chancelier → Burgundy; Les Aricoques → Savoie; D'Arcy → Barolo; Muxin → China; Lucas Salmon & Quatre Piliers → Loire) and dropped 2 non-producers (Maison Marrain = handbags; Cascina Lago Scuro = restaurant). Taxonomy: +China (and earlier +Australia/Japan/Canada/Sweden/Canary Islands). lint 0; rollups 52 region pages; index 624→ (75,628 bytes). 12 of the 112 were already in the vault. Followup: famous-estate farming/importer left [] where not cleanly verifiable (per Evan); enrich later from clippings.
